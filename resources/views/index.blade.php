...
<html lang="en">
  ...
  <body class="index-page">
      ...
      >
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="#aboutUsf">Tentang Kami</a></li>
            <li><a href="courses.html">Mengapa Kami?</a></li>
            <li><a href="trainers.html">Siswa Siswi Unesco</a></li>
    ...
    <main class="main">
      ...
      <section id="hero" class="hero section dark-background">
        ...
        <div class="container">
          ...
          <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
            <a href="#aboutUs" class="btn-get-started">Tentang Kami</a>
          </div>
        </div>
      </section>
      <!-- /Hero Section -->
      ...
      <!-- About Section -->
      <section id="aboutUs" class="about section" style="padding-top: 10rem;">
        <div class="container">
          <div class="row gy-4">
            <div
            ...
            >
              ...
              <ul>
                <li>
                  ...
                  <span
                    >SIMKU ini adalah salah satu project SAS kami (Sumaif Akhir
                    Semester)</span
                  >
                </li>
                <li>
                  <i class="bi bi-check-circle"></i>
                  <span
                    >Memudahkan pencatatan keuangan yang transparan untuk kelas
                    kami.</span
                  >
                </li>
                <li>
                  <i class="bi bi-check-circle"></i>
                  <span
                    >Memberikan akses kepada siswa untuk melihat kondisi
                    keuangan kapan saja dan di mana saja.</span
                  >
                </li>
              </ul>
              <a href="#kenapa-kami" class="read-more"
